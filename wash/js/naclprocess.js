...
NaClProcessManager.prototype.handleMessage_ = function(e) {
  ...
  var handlers = {
    ...
    nacl_debug: this.handleDebug_,
    nacl_result: this.handleResult_,
  };
  ...
  // Sometimes null messages come in. We can't do much with them.
  if (msg === null)
    return;
 ...
 *  @private
 */
NaClProcessManager.prototype.handleDebug_ = function(msg) {
  console.log(msg.message);
}

/** Handles operation result.
 *  @private
 */
NaClProcessManager.prototype.handleResult_ = function(msg) {
...
NaClProcessManager.prototype.exit = function(code, element) {
  ...
  if (element.parentNode === wash.mounter.win.document.body) {
    wash.mounter.win.document.body.removeChild(element);
  }
...
NaClProcessManager.prototype.spawn = function(
  ...
  self.naclArch(function(naclArch) {
    ...
    var fg = wash.mounter.win.document.createElement('object');
    ...
    function addParam(name, value) {
      ...
      var param = wash.mounter.win.document.createElement('param');
      param.name = name;
      param.value = value;
    ...
    var args = parseQuery(wash.mounter.win.document.location.search);
    ...
    if (params[NaClProcessManager.ENV_SPAWN_MODE] ===
      ...
      wash.mounter.win.document.body.appendChild(fg);
    }
